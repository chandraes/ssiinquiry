...
<body class="theme-primary">
	<header class="left-menu">
			  ...
			  <div class="col-lg-6 col-12 xs-mb-10">
				<div class="topbar-call text-center text-lg-right topbar-right">
				  <ul class="list-inline d-lg-flex justify-content-end">				  
					 <li class="mr-10 pl-10"><a href="{{route('register')}}"><i class="text-primary fa fa-user d-md-inline-block d-none"></i> Register</a></li>
					 <li class="mr-10 pl-10"><a href="{{route('login')}}"><i class="text-primary fa fa-sign-in d-md-inline-block d-none"></i> Login</a></li>
				  </ul>
				</div>
			  </div>
			 </div>
		...
		{{-- <nav hidden class="nav-primary nav-transparent text-left"> --}}
		@php
			$logoPath = get_setting('app_logo');
			$logoUrl = $logoPath ? asset('storage/' . $logoPath) : asset('assets/images/brand/logo.png');
		@endphp
		<nav hidden class="nav-white nav-transparent text-primary">
    ...
    {{-- <section class="bg-img pt-200 pb-120" data-overlay="1" style="background-image: url(../images/front-end-img/banners/banner-1.jpg); background-position: top center;">
		<div class="container">
			<div class="row">
				<div class="col-12">
					...
					{{-- <div class="box box-body p-xl-50 p-30"> --}}
						<div class="row align-items-center  text-center">
							<div class="col-lg-12 col-12">
								...
								<h1 class="mb-15">Apa itu SSI Inquiry?</h1>
								{{-- <h4 class="font-weight-400 text-muted">SSI Inquiry</h4> --}}
								<p class="font-size-14">SSI Inquiry adalah platform penelitian interaktif yang dirancang untuk memproses dan menganalisis data eksperimen yang dikumpulkan melalui aplikasi Phypox.<br><br>
									Dengan SSI Inquiry, peneliti dapat mengunggah data sensor, melakukan analisis statistik, dan memvisualisasikan hasilnya dengan cepat — semua langsung dari browser, tanpa instalasi tambahan.</p>
							...
							<div class="px-15 pt-15">
								<div class="row">
									<div class="col-lg-3 col-md-6 col-12">
										<div class="box">
											<a href="#">
												<img class="card-img-top" src="{{asset('frontend/images/front-end-img/courses/4.jpg')}}" alt="Card image cap">
											</a>
											<div class="box-body"> 
												<div class="text-left">
									...
									<div class="col-lg-3 col-md-6 col-12">
										<div class="box">
											<a href="#">
												<img class="card-img-top" src="{{asset('frontend/images/front-end-img/courses/6.jpg')}}" alt="Card image cap">
											</a>
											<div class="box-body"> 
												<div class="text-left">
									...
									<div class="col-lg-3 col-md-6 col-12">
										<div class="box">
											<a href="#">
												<img class="card-img-top" src="{{asset('frontend/images/front-end-img/courses/5.jpg')}}" alt="Card image cap">
											</a>
											<div class="box-body"> 
												<div class="text-left">
									...
									<div class="col-lg-3 col-md-6 col-12">
										<div class="box">
											<a href="#">
												<img class="card-img-top" src="{{asset('frontend/images/front-end-img/courses/2.jpg')}}" alt="Card image cap">
											</a>
											<div class="box-body"> 
												<div class="text-left">
									...
									<div class="col-lg-3 col-md-6 col-12">
										<div class="box">
											<a href="#">
												<img class="card-img-top" src="{{asset('frontend/images/front-end-img/courses/7.jpg')}}" alt="Card image cap">
											</a>
											<div class="box-body"> 
												<div class="text-left">
									...
									<div class="col-lg-3 col-md-6 col-12">
										<div class="box">
											<a href="#">
												<img class="card-img-top" src="{{asset('frontend/images/front-end-img/courses/8.jpg')}}" alt="Card image cap">
											</a>
											<div class="box-body"> 
												<div class="text-left">
									...
									<div class="col-lg-3 col-md-6 col-12">
										<div class="box">
											<a href="#">
												<img class="card-img-top" src="{{asset('frontend/images/front-end-img/courses/9.jpg')}}" alt="Card image cap">
											</a>
											<div class="box-body"> 
												<div class="text-left">
									...
									<div class="col-lg-3 col-md-6 col-12">
										<div class="box">
											<a href="#">
												<img class="card-img-top" src="{{asset('frontend/images/front-end-img/courses/10.jpg')}}" alt="Card image cap">
											</a>
											<div class="box-body"> 
												<div class="text-left">
			...
			<div class="row mt-30">
				<div class="col-12">
					<div class="owl-carousel owl-theme owl-btn-1" data-nav-arrow="false" data-nav-dots="false" data-items="6" data-md-items="4" data-sm-items="3" data-xs-items="2" data-xx-items="2">
						<div class="item"><img src="{{asset('frontend/images/front-end-img/unilogo/uni-1.jpg')}}" class="img-fluid my-15 rounded box-shadowed pull-up" alt="" ></div>
						<div class="item"><img src="{{asset('frontend/images/front-end-img/unilogo/uni-2.jpg')}}" class="img-fluid my-15 rounded box-shadowed pull-up" alt="" ></div>
						<div class="item"><img src="{{asset('frontend/images/front-end-img/unilogo/uni-3.jpg')}}" class="img-fluid my-15 rounded box-shadowed pull-up" alt="" ></div>
						<div class="item"><img src="{{asset('frontend/images/front-end-img/unilogo/uni-4.jpg')}}" class="img-fluid my-15 rounded box-shadowed pull-up" alt="" ></div>
						<div class="item"><img src="{{asset('frontend/images/front-end-img/unilogo/uni-5.jpg')}}" class="img-fluid my-15 rounded box-shadowed pull-up" alt="" ></div>
						<div class="item"><img src="{{asset('frontend/images/front-end-img/unilogo/uni-6.jpg')}}" class="img-fluid my-15 rounded box-shadowed pull-up" alt="" ></div>
						<div class="item"><img src="{{asset('frontend/images/front-end-img/unilogo/uni-7.jpg')}}" class="img-fluid my-15 rounded box-shadowed pull-up" alt="" ></div>
						<div class="item"><img src="{{asset('frontend/images/front-end-img/unilogo/uni-8.jpg')}}" class="img-fluid my-15 rounded box-shadowed pull-up" alt="" ></div>
						<div class="item"><img src="{{asset('frontend/images/front-end-img/unilogo/uni-9.jpg')}}" class="img-fluid my-15 rounded box-shadowed pull-up" alt="" ></div>
						<div class="item"><img src="{{asset('frontend/images/front-end-img/unilogo/uni-10.jpg')}}" class="img-fluid my-15 rounded box-shadowed pull-up" alt="" ></div>
						<div class="item"><img src="{{asset('frontend/images/front-end-img/unilogo/uni-11.jpg')}}" class="img-fluid my-15 rounded box-shadowed pull-up" alt="" ></div>
						<div class="item"><img src="{{asset('frontend/images/front-end-img/unilogo/uni-12.jpg')}}" class="img-fluid my-15 rounded box-shadowed pull-up" alt="" ></div>
					</div>
				</div>
			</div>
		</div>
							...
							<div class="px-15 pt-15">
								<div class="row">
									<div class="col-lg-3 col-md-6 col-12">
										<div class="card">
											<a href="#">
												<img class="card-img-top" src="{{asset('frontend/images/front-end-img/courses/1.jpg')}}" alt="Card image cap">
											</a>
						...
						<div class="box-body">
							<div>
								<div class="d-flex align-items-center mb-30">
									<div class="mr-15">
										<img src="{{asset('frontend/images/front-end-img/avatar/1.jpg')}}" class="avatar avatar-lg rounded10" alt="">
									</div>
					...
					<div class="box pull-up">
						<div class="box-body">
							<div>
								<div class="d-flex align-items-center mb-30">
									<div class="mr-15">
										<img src="{{asset('frontend/images/front-end-img/avatar/2.jpg')}}" class="avatar avatar-lg rounded10" alt="">
									</div>
									<div class="d-flex flex-column font-weight-500">
					...
					<div class="box pull-up">
						<div class="box-body">
							<div>
								<div class="d-flex align-items-center mb-30">
									<div class="mr-15">
										<img src="{{asset('frontend/images/front-end-img/avatar/3.jpg')}}" class="avatar avatar-lg rounded10" alt="">
									</div>
									<div class="d-flex flex-column font-weight-500">
					...
					<div class="box pull-up">
						<div class="box-body">
							<div>
								<div class="d-flex align-items-center mb-30">
									<div class="mr-15">
										<img src="{{asset('frontend/images/front-end-img/avatar/4.jpg')}}" class="avatar avatar-lg rounded10" alt="">
									</div>
									<div class="d-flex flex-column font-weight-500">
					...
					<div class="box pull-up">
						<div class="box-body">
							<div>
								<div class="d-flex align-items-center mb-30">
									<div class="mr-15">
										<img src="{{asset('frontend/images/front-end-img/avatar/5.jpg')}}" class="avatar avatar-lg rounded10" alt="">
									</div>
									<div class="d-flex flex-column font-weight-500">
					...
					<div class="box pull-up">
						<div class="box-body">
							<div>
								<div class="d-flex align-items-center mb-30">
									<div class="mr-15">
										<img src="{{asset('frontend/images/front-end-img/avatar/6.jpg')}}" class="avatar avatar-lg rounded10" alt="">
									</div>
									<div class="d-flex flex-column font-weight-500">
										<a href="#" class="text-dark hover-primary mb-1 font-size-16">Johen Doe</a>
					...
					<div class="box pull-up">
						<div class="box-body">
							<div>
								<div class="d-flex align-items-center mb-30">
									<div class="mr-15">
										<img src="{{asset('frontend/images/front-end-img/avatar/7.jpg')}}" class="avatar avatar-lg rounded10" alt="">
									</div>
									<div class="d-flex flex-column font-weight-500">
					...
					<div class="box pull-up">
						<div class="box-body">
							<div>
								<div class="d-flex align-items-center mb-30">
									<div class="mr-15">
										<img src="{{asset('frontend/images/front-end-img/avatar/8.jpg')}}" class="avatar avatar-lg rounded10" alt="">
									</div>
									<div class="d-flex flex-column font-weight-500">
		...
		<div class="container">
			...
			<div class="row mt-30">
				...
				<div class="col-lg-3 col-md-6 col-12">
					<div class="card">
						<a href="#">
							<img class="card-img-top" src="{{asset('frontend/images/front-end-img/courses/3.jpg')}}" alt="Card image cap">
						</a>
						<div class="position-absolute r-10 t-10"> 
							<button type="button" class="waves-effect waves-circle btn btn-circle btn-dark btn-xs mr-5"><i class="fa fa-heart-o"></i></button>
							<button type="button" class="waves-effect waves-circle btn btn-circle btn-dark btn-xs mr-5"><i class="fa fa-share-alt"></i></button>
	...
	<section class="py-50 bg-img countnm-bx" style="background-image: url(../images/front-end-img/background/bg-3.jpg)" data-overlay="1" data-aos="fade-up">
		<div class="container">
			<div class="row">
				<div class="col-lg-3 col-md-6 col-12">
					<div class="text-center">
					...
					<div class="col-12 col-lg-3">
                        <div class="widget widget_gallery clearfix">
                            ...
                            <ul class="list-unstyled">
								<li><img src="{{asset('frontend/images/gallery/thumb/1.jpg')}}" alt=""></li>
								<li><img src="{{asset('frontend/images/gallery/thumb/2.jpg')}}" alt=""></li>
								<li><img src="{{asset('frontend/images/gallery/thumb/3.jpg')}}" alt=""></li>
								<li><img src="{{asset('frontend/images/gallery/thumb/4.jpg')}}" alt=""></li>
								<li><img src="{{asset('frontend/images/gallery/thumb/5.jpg')}}" alt=""></li>
								<li><img src="{{asset('frontend/images/gallery/thumb/6.jpg')}}" alt=""></li>
								<li><img src="{{asset('frontend/images/gallery/thumb/7.jpg')}}" alt=""></li>
								<li><img src="{{asset('frontend/images/gallery/thumb/8.jpg')}}" alt=""></li>
								<li><img src="{{asset('frontend/images/gallery/thumb/9.jpg')}}" alt=""></li>
								<li><img src="{{asset('frontend/images/gallery/thumb/10.jpg')}}" alt=""></li>
								<li><img src="{{asset('frontend/images/gallery/thumb/11.jpg')}}" alt=""></li>
								<li><img src="{{asset('frontend/images/gallery/thumb/12.jpg')}}" alt=""></li>
							</ul>
                        </div>
                    </div>
					<div class="col-lg-3 col-12">
		...
		<div class="footer-bottom bg-dark3">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-12 col-12 text-md-center text-center"> © 2025 
						{{-- <span class="text-white">EduAdmin</span>   --}}
						All Rights Reserved.
					</div>
