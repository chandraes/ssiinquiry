                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="responsive-logo">
                                <a href="index.html" class="header-logo">
                                    {{-- [DIUBAH] alt text --}}
                                    <img src="{{ $logoUrl }}" class="mobile-logo logo-1" alt="{{ __('admin.logo_alt') }}" height="50px">
                                    <img src="{{ $logoUrl }}" class="mobile-logo dark-logo-1" alt="{{ __('admin.logo_alt') }}" height="50px">
                                </a>
                            </div>
