        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="POST" id="editForm" enctype="multipart/form-data">
                    ...
                    {{-- Select Phyphox --}}
                    <div class="mb-3">
                        <label for="edit_phyphox_id" class="form-label">Alat Phyphox Terkait (Opsional)</label>
                        ...
                        <select name="phyphox_id[]" id="edit_phyphox_id" class="form-control select2-phyphox-edit" multiple="multiple" style="width: 100%;">
                         ...
                         <small class="text-muted">Pilih satu atau lebih alat Phyphox yang relevan.</small>
                    </div>
