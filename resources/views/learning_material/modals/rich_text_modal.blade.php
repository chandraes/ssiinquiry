<div class="modal fade" id="addRichTextModal" tabindex="-1">
    <div class="modal-dialog modal-lg"> {{-- Dibuat lebih besar (modal-lg) --}}
                ...
                <div class="modal-body">
                    ...
                    <ul class="nav nav-tabs mb-3" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="content-id-tab-rt" data-bs-toggle="tab" data-bs-target="#content-id-pane-rt" type="button" role="tab">ID</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="content-en-tab-rt" data-bs-toggle="tab" data-bs-target="#content-en-pane-rt" type="button" role="tab">EN</button>
                        </li>
                    </ul>
