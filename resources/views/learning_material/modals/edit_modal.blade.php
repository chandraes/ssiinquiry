        ...
        <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="" method="POST" id="editMaterialForm">
                        ...
                        <label class="form-label fw-bold">{{ __('admin.material_modal.material_title') }}</label>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" form="editMaterialForm" class="btn btn-primary">{{ __('admin.submodul_modal.save_changes') }}</button>
                </div>
            </div>
        </form>
    </div>
